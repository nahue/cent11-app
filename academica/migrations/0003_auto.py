...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field titulos on 'Persona'
        m2m_table_name = db.shorten_name(u'academica_persona_titulos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('persona', models.ForeignKey(orm[u'academica.persona'], null=False)),
            ('titulo', models.ForeignKey(orm[u'academica.titulo'], null=False))
        ))
        db.create_unique(m2m_table_name, ['persona_id', 'titulo_id'])


    def backwards(self, orm):
        # Removing M2M table for field titulos on 'Persona'
        db.delete_table(db.shorten_name(u'academica_persona_titulos'))
