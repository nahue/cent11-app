...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Materia', fields ['codigo']
        db.create_unique(u'academica_materia', ['codigo'])

        # Adding unique constraint on 'Carrera', fields ['codigo']
        db.create_unique(u'academica_carrera', ['codigo'])


    def backwards(self, orm):
        # Removing unique constraint on 'Carrera', fields ['codigo']
        db.delete_unique(u'academica_carrera', ['codigo'])

        # Removing unique constraint on 'Materia', fields ['codigo']
        db.delete_unique(u'academica_materia', ['codigo'])


    models = {
        u'academica.carrera': {
            'Meta': {'object_name': 'Carrera'},
            'codigo': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '10'}),
        ...
        u'academica.materia': {
            ...
            'docentes': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['academica.Persona']", 'symmetrical': 'False'}),
