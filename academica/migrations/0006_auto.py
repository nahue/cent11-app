...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field docentes on 'Materia'
        m2m_table_name = db.shorten_name(u'academica_materia_docentes')
        ...
        db.create_unique(m2m_table_name, ['materia_id', 'persona_id'])
    ...
    def backwards(self, orm):
        # Removing M2M table for field docentes on 'Materia'
        db.delete_table(db.shorten_name(u'academica_materia_docentes'))
