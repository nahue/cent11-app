...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.observacion'
        db.alter_column(u'academica_persona', 'observacion', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Persona.observacion'
        db.alter_column(u'academica_persona', 'observacion', self.gf('django.db.models.fields.TextField')(default=''))
