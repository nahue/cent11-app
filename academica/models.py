...
class Persona(models.Model):
  ...
  nacimiento_ciudad = models.CharField(_('nacimiento_ciudad'),max_length=30,blank=True)
  email = models.EmailField()
  domicilio = models.CharField(max_length=30)
  telefono = models.CharField(max_length=15)
  sexo = models.CharField(max_length=1, choices=SEXO)
  fecha_alta = models.DateField(_('fecha_alta'),null=True, blank=True)
...
class Materia(models.Model):
  ...
  aprobadas_para_rendir = models.CharField(max_length = 30, default='', blank=True)
